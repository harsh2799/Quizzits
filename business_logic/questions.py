...
# conn.execute("CREATE TABLE qa (id INTEGER PRIMARY KEY AUTOINCREMENT, question LONGTEXT NOT NULL, options LONGTEXT NOT NULL, correct_ans LONGTEXT NOT NULL)")
...
for question in questions:
   ...
   conn.execute(f"""insert into qa(`question`,`options`,`correct_ans`) values("{ques}","{options}","{correct_ans}")""")
   conn.commit()
